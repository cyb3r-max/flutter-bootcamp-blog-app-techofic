...
import 'package:bootcamp_app/controller/navController.dart';
...
class _MyAppState extends ConsumerState<MyApp> {
  ...
  void initState() {
    ...
    ref.read(FavoriteblogsListProvider.notifier).fetchFavBlogsList();
  }
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const NavigationBarController(),
    );
  }
}
